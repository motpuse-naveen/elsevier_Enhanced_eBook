...
var quiz = [
    ...
    {
        q: `Dyspnoea is a symptom most closely associated with which condition? Question Image: <img xmlns="http://www.w3.org/1999/xhtml" src="../images/x.png" style="height: 20px;" />`,
        q2: ``,
        q3: [],
        option: [`Chronic bronchitis`, `Asthma`, `Heart failure`, `Pneumonia`, `Tuberculosis - Option Image: <img xmlns="http://www.w3.org/1999/xhtml" src="../images/x.png" style="height: 20px;" />`],
    ...
    {
        q: `You are recommending treatment for a young woman to treat a common cold (primary symptom of nasal congestion). She tells you that she is breastfeeding. What would be the most suitable option? Math Equation: \\(ax^2 + bx + c = 0\\)`,
        q2: ``,
        q3: [],
        option: [` Vitamin C`, `Steam inhalation`, `Oral sympathomimetics`, `Topical sympathomimetics`, `Antihistamines <span>Math Equation $$x = {-b \\pm \\sqrt{b^2-4ac} \\over 2a}.$$</span>`],
        answer: 3,
    ...
    {
        q: `Simon, who is 32 years old, presents with a "nonproductive" cough of 6 day's duration. He has no other symptoms and takes no medication. What would be the most appropriate course of action to take?`,
        q2: ``,
        q3: [],
